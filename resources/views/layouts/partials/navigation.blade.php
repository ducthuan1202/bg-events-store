    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('aggregates.index') }}" class="nav-link">Aggregates</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
        ...
        {{ Form::open(['method' => 'GET', 'url' => route('events.index'), 'class' => 'form-inline ml-3']) }}
            <div class="input-group input-group-sm">
                {{ Form::text('keyword', '', ['class'=> 'form-control form-control-navbar', 'placeholder'=>'Search Events']) }}
